...
public class ResourceLinkPoolBean {
    String textContent="";
    ComponentLinkBean componentLinkBean ;
  ...
  public void setTextContent(String textContent) { 
    ...
    public ComponentLinkBean getComponentLinkBean() { 
		if(componentLinkBean==null) componentLinkBean=new ComponentLinkBean(); 
		return componentLinkBean;
	} 
  public void setComponentLinkBean( ComponentLinkBean componentLinkBean ) { 
  ...
  public void setInterpretingParamsLinkBean( InterpretingParamsLinkBean interpretingParamsLinkBean ) { 
    ...
    public LayoutPreparationParamsLinkBean getLayoutPreparationParamsLinkBean() { 
		if(layoutPreparationParamsLinkBean==null) layoutPreparationParamsLinkBean=new LayoutPreparationParamsLinkBean(); 
