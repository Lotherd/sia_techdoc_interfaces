...
public class WoTaskCard implements Serializable {
  ...
  @EmbeddedId private WoTaskCardPK id;
  ...
  */
  ...
  public void setWoTaskCardWorkInProgresses(
      List<WoTaskCardWorkInProgress> woTaskCardWorkInProgresses) {
    this.woTaskCardWorkInProgresses = woTaskCardWorkInProgresses;
  }

  public WoTaskCardWorkInProgress addWoTaskCardWorkInProgress(
      WoTaskCardWorkInProgress woTaskCardWorkInProgress) {
  ...
  public WoTaskCardWorkInProgress removeWoTaskCardWorkInProgress(
      WoTaskCardWorkInProgress woTaskCardWorkInProgress) {
